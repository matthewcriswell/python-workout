...
class Zoo:
    ...
    def transfer_animal(self, target_zoo, animal):
        ''' removes animal from target_zoo '''
        for cage in self.cages:
            print(f'cage is a {type(cage)}')
            for source_animal in cage.cage:
                if isinstance(source_animal, animal):
                    cage.cage.remove(source_animal)
                    target_zoo.cages[0].cage.append(source_animal)
...
c3 = Cage(3)
c3.add_animals(wolf2, sheep2)
c4 = Cage(4)
c4.add_animals(snake2, parrot2)
...
print(z2)
print('transfering a parrot')
z.transfer_animal(z2, Parrot)
print("")
print(z)
print("")
print(z2)
